...
const bookSchemaUpdate = require("../schemas/bookSchemasUpdate.json");
...
router.post("/", async function (req, res, next) {
  try {
    const results = validate(req.body, bookSchemaNew)
...
router.put("/:isbn", async function (req, res, next) {
  try {
    ...
    const results = validate(req.body, bookSchemaUpdate);
